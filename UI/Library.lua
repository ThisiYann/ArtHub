...
if not isfolder("ArtHub/cfg") then
    makefolder("ArtHub/cfg")
end
...
local ArtUI = {}
function ArtUI:MakeNotify(NotifyConfig)
...
function ArtNotify(msg, delay, color, title, desc)
    return ArtUI:MakeNotify({
...
function ArtUI:Window(GuiConfig)
